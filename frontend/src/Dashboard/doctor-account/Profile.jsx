...
const Profile = ({ doctorData }) => {
  ...
  //resulable function for adding item

  const addItem = (key, item) => {
    setFormData(prevFormData => ({ ...prevFormData, [key]: [...prevFormData[key], item] }));
  };

  //resulable input change function
  ...
  //resulable function for deleting item
      ...
      <form>
          ...
          <div className="grid grid-cols-3 gap-5 mb-[30px]">
            <div>
              ...
              <select name="gender" value={formData.gender}
                onChange={handleInputChange} className="form__input py-3.5">
        ...
        <div className="mb-5 flex items-center gap-3">
          {formData.photo && <figure className='w-[60px] h-[60px] rounded-full border-2 border-solid border-primaryColor flex items-center justify-center'>
            <img src={formData} alt='' className='w-full rounded-full ' />
          </figure>}
        ...
        <div className="mt-7">
          <button type="submit" onClick={updateProfileHandler} className="bg-primaryColor text-white text-[18px] leading-[30px] w-full py-3 px-3 rounded-lg">
            Update Profile
          </button>
        </div>
      </form>
